...
public class GameState1 extends GameState implements State{
	...
	public void init() {
		...
		tiles.add(new Tile(100, 480 - 64 - 64, new Sprite(new SpriteSheet(new Texture("hoverbox"), 64), 1, 1)));
		tiles.add(new Tile(220, 480-(64*3), new Sprite(new SpriteSheet(new Texture("hoverbox"), 64), 1, 1)));
		tiles.add(new Tile(340, 480-(64*4), new Sprite(new SpriteSheet(new Texture("hoverbox"), 64), 1, 1)));
