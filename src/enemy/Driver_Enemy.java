...
public class Driver_Enemy {
	...
	public static void main(String[] args) 
	{
		...
		System.out.println("Test for FlyEnemy gets info from Enemy class: X:" + f1.locX +  ", Y:"  + f1.locY + ", HitX:" + f1.hitboxX + ", HitY:" + f1.hitboxY
				+  ", name:" + f1.name);
		System.out.println("Test for GroundEnemy gets info from Enemy class: X:" + g1.locX +  ", Y:"  + g1.locY + ", HitX:" + g1.hitboxX + ", HitY:" + g1.hitboxY
				+  ", name:" + g1.name);
		...
		{
			f1.move(2);
			System.out.println("FlyE YLoc: " + f1.locY );
		}
		...
		{
			g1.move(1);
			System.out.println("GroundE XLoc: " + g1.locX );
		}
